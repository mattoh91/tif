#!/usr/bin/env python3
"""Compile Tif skills to agent-native instruction formats.

This is intentionally dependency-free. It supports the common Tif skill shape:
...
MARKER_START = "<!-- tif-compile:{name} -->"
MARKER_END = "<!-- /tif-compile:{name} -->"
