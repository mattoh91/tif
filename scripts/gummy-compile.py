#!/usr/bin/env python3
"""Compile Gummy skills to agent-native instruction formats.

This is intentionally dependency-free. It supports the common Gummy skill shape:
...
MARKER_START = "<!-- gummy-compile:{name} -->"
MARKER_END = "<!-- /gummy-compile:{name} -->"
