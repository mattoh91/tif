## 1. Operational and Documentation Organisation
  ...
  sequence diagrams should be drawn into ARCHI.md as mermaid models. Collectively these should correspond to the cutiepie specs document. the original brainfart when organised
  into biz requiremetns can become a PRD that is analogous to the cutiepie plan document. If there are any gaps between my suggestion and cutiepie plan and specs you must
  flag them out to me urgently.
  ## 2. Context aware requirements gathering
  ### 2.1. Context
  Cutiepie is great at spec'ing (tech requirements) but i feel it doesn't quite help to suggest for missing related features. Case in point: An agentic rag backend i built -
