# Tif Agentic Engineering Guidelines

Tif works at two levels:

- **Stories** live in `.tif/docs/PRD.md`.
- **Specs** live under `.tif/plans/story_*/specs/` and are the implementation/completion unit.
...
Run `scripts/check-tif-state.sh .` before claiming completion.
