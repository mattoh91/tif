...
assert_contains "$output" "check-tif-state\|contracts.json\|spec_.*md\|ADR" "Mentions story state contract"

output=$(run_claude "When can a Tif story spec be marked completed=true?" 30)
