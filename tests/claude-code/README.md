...
Automated tests for cutiepie skills using Claude Code CLI.
...
- Local cutiepie plugin installed (see main README for installation)
...
- `create_test_plan project_dir` - Create sample `.cutiepie/docs` spec set
