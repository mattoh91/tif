...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/sweet
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/sweet-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using sweet:subagent-driven-development. The plan is at: $PLAN_PATH"
