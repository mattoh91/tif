...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/cutiepie
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/cutiepie-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using cutiepie:subagent-driven-development. The plan is at: $PLAN_PATH"
