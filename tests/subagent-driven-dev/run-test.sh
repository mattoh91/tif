...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/tif
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/tif-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using tif:subagent-driven-development. The plan is at: $PLAN_PATH"
