...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/gummy
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/gummy-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using gummy:subagent-driven-development. The plan is at: $PLAN_PATH"
