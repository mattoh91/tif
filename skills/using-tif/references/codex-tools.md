...
Claude Code skills reference named agent types like `tif:code-reviewer`.
...
|-------------------|------------------|
| `Task tool (tif:code-reviewer)` | `spawn_agent(agent_type="worker", message=...)` with `code-reviewer.md` content |
