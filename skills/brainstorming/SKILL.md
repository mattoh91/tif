---
name: brainstorming
description: Use when the user starts with an idea or asks what to build; routes Tif planning through project intake, PRD stories, story specs, contract design, and approval.
---
...
2. Use `prd-discovery` to write or update `.tif/docs/PRD.md` with stories.
3. Use `story-planner` to create one `.tif/plans/story_<nnn>_<slug>/` folder per story.
