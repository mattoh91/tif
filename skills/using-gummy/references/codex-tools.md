...
Claude Code skills reference named agent types like `gummy:code-reviewer`.
...
|-------------------|------------------|
| `Task tool (gummy:code-reviewer)` | `spawn_agent(agent_type="worker", message=...)` with `code-reviewer.md` content |
