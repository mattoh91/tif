...
Claude Code skills reference named agent types like `cutiepie:code-reviewer`.
...
|-------------------|------------------|
| `Task tool (cutiepie:code-reviewer)` | `spawn_agent(agent_type="worker", message=...)` with `code-reviewer.md` content |
