...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TIF_ALLOW_RISKY_MEMORY` | Tif memory review | boolean env flag | unset | no | `1` or unset | memory review | Allows promotion of high-risk memory candidates only when explicitly set. Leave unset by default. |
...
- Story-specific decisions belong in `.tif/plans/story_*/ADR.md`.
