...
description: Use when bootstrapping a new or under-structured repo with Tif docs, story ADRs/specs/contracts, repo review, Brewery client, and baseline commands.
---

# Scaffolding Repo

Tif adopts the project; the project does not have to contort itself around Tif.
...
- `.tif/docs/ARCHI.md`
- `.tif/docs/CONFIG.md`
- `.tif/plans/story_001_initial_workflow/ADR.md`
- `.tif/plans/story_001_initial_workflow/contracts.json`
- `.tif/plans/story_001_initial_workflow/specs/spec_001_initial_slice.md`
- `init.sh`
- `Makefile`
...
6. For brownfield repos, write `.tif/docs/REPO_REVIEW.md` and update `.tif/docs/ARCHI.md`.
...
Write findings to `.tif/docs/REPO_REVIEW.md`.
...
- Document `GENAI_API_KEY` in `.tif/docs/CONFIG.md`.
...
- record the setup in `.tif/docs/CONFIG.md`
