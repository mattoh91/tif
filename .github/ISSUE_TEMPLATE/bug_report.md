...
## Is this a Sweet issue or a platform issue?
<!-- Sweet is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Sweet installed.

     If the problem persists without Sweet, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Sweet installed
