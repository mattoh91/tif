...
- `.tif/plans/story_*/specs/spec_*.md` owns spec completion state, dependencies, contract references, and acceptance checks.
- `.tif/plans/story_*/contracts.json` owns cross-spec data contracts after specs are drafted.
...
- `project-intake` inspects repo and Tif state first.
...
- Tif keeps Hephaestus' useful gates without inheriting a heavyweight questionnaire.
