...
acceptance_checks:
  ...
  - id: check_002
    ...
    steps:
      - "Step 1: Search for Tif/tif across manifests, docs, skills, hooks, commands, tests, package metadata, and memory paths."
...
The user selected Tif. The namespace appears in:

- `.tif/` active state paths
- `~/.tif/memory/`
