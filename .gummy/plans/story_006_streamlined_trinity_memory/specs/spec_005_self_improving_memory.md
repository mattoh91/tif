...
```json
{
  ...
  "source": {
    ...
    "path": "~/.gummy/memory/<slug>/SESSIONS/2026-06-29.md",
  ...
  "verification": {
    "command": "scripts/check-gummy-state.sh .",
    "result": "pending"
  }
}
```
