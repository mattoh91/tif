...
- `.gummy/plans/story_*/specs/spec_*.md` owns spec completion state, dependencies, contract references, and acceptance checks.
- `.gummy/plans/story_*/contracts.json` owns cross-spec data contracts after specs are drafted.
...
- The harness no longer needs separate global completion, story plan, workflow, or house-rules files.
...
- `project-intake` inspects repo and Gummy state first.
...
- Gummy keeps Hephaestus' useful gates without inheriting a heavyweight questionnaire.
